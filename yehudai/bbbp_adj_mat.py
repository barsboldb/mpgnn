...
def main(args):
    ...
    dataset = PygGraphPropPredDataset(root='dataset', name='ogbg-molbbbp')
    ...
    if args.use_wandb:
        ...
        config_dict['dataset'] = 'ogbg-molbbbp'
    ...
    for epoch in range(args.num_epochs):
        ...
        print(f"Epoch {epoch + 1}/{args.num_epochs}, Train Loss: {train_loss:.4f}, Val ROC-AUC: {val_metrics['rocauc']:.4f}, Test ROC-AUC: {test_metrics['rocauc']:.4f}")
        ...
        if args.use_wandb:
            wandb.log({"Train Loss": train_loss, "Validation ROC-AUC": val_metrics['rocauc'],
                       "Epoch": epoch + 1, 'Test ROC-AUC': test_metrics, 'Best Val ROC-AUC': best_val_test_rocauc, 'Best Test ROC-AUC': best_test_test_rocauc, 'Best Val Val ROC-AUC': best_val_val_rocauc})
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Transformer Model for ogbg-molbbbp')
