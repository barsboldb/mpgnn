...
from counting_datatset import GraphCountDatasetNnodes
import time
...
def main(args):
    ...
    avg_nodes = mean([data.num_nodes for data in dataset])
...
if __name__ == '__main__':
    ...
    parser.add_argument('--task_num', type=int, default=0, help='tri,tailed,star,cyc4,cus')
