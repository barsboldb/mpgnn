...
def main(args):
    ...
    dataset = PygGraphPropPredDataset(root='dataset', name='ogbg-molbace')
    ...
    if args.use_wandb:
        ...
        config_dict['dataset'] = 'ogbg-molbace'
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Transformer Model for ogbg-molbace')
